 ...
 *  @brief Clase para gestionar el funcionamiento del m�dulo XBee
 *  @authors
...
public class DispositivoXBee implements Observable, Observer {
	...
	/**
	 * @brief M�todo para conectar la XBee al puerto COM asignado
	 * @return void
	 */
	...
	/**
	 * @brief M�todo para a�adir un listener al dispositivo XBee
	 * @return void
	 */
	...
	/**
	 * @brief M�todo para iniciar la XBee
	 * @return void
	 */
	...
	/**
	 * @brief M�todo para detener la XBee
	 * @return void
	 */
	...
	/**
	 * @brief M�todo para transfomar un n�mero decimal
	 * @param numero N�mero decimal (0-255) que se desea convertir a binario
	 * @return void
	 */
	...
	/**
	 * @brief M�todo para enviar una trama de datos binarios
	...
	/**
	 * @brief M�todo para enviar al coche las dimensiones del circuito
	 * @param tipoRecorrido Indica si es una recta o una curva
	 * @param numeroVueltasRueda N�mero de vueltas que tiene que dar la rueda para recorrer la recta o la curva
	 * @return void
	 */
	...
	/**
	 * @brief M�todo para enviar al coche los datos para realizar el circuito
	 * @param tipoAccion Indica si mover el servo o el motor
	 * @param direccion Indica la direcci�n en la que se va a mover el servo o el motor
	...
	/**
	 * @brief M�todo para enviar al coche los datos para realizar las diferentes pruebas
	 * @param tipoPrueba Indica que tipo de prueba se va a realizar
	 * @param direccion Indica la direcci�n en la que se va a mover el servo o el motor
	 * @param estado Iniciar o detener el movimiento
	 * @param valor Valor que var�a en funci�n del tipo de prueba
	 * @return void
	 */
	...
	/**
	 * @brief M�todo para comprobar si el dispositivo local est� activo
	 * @return boolean
	 */
	...
	/**
	 * @brief M�todo para detectar los datos enviados por el coche
	...
	/**
	 * @brief M�todo para obtener el valor del objeto dispositivoLocal
	 * @return XBeeDevice
	 */
	...
	/**
	 * @brief M�todo para obtener el valor de la variable activado
	 * @return boolean
	 */
	...
	/**
	 * @brief M�todo para establecer el valor de la variable errorEnvio
	 * @return void
	 */
