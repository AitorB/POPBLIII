 ...
 * @brief Clase para gestionar el funcionamiento del modulo XBee
...
public class DispositivoXBee implements Observable, Observer {
    ...
    /**
     * @brief Metodo para conectar la XBee al puerto COM asignado
     * @return void
     */
    ...
    /**
     * @brief Metodo para anadir un listener al dispositivo XBee
     * @return void
     */
    ...
    /**
     * @brief Metodo para iniciarBtn la XBee
     * @return void
     */
    ...
    /**
     * @brief Metodo para detenerBtn la XBee
     * @return void
     */
    ...
    /**
     * @brief Metodo para transfomar un numero decimal
    ...
    /**
     * @brief Metodo para enviar una trama de datos binarios
    ...
    /**
     * @brief Metodo para enviar al coche las dimensiones del circuito
     * @param tipoRecorrido Indica si es una recta o una curva
     * @param numeroVueltasRueda Numero de vueltas que tiene que dar la rueda para recorrer la recta o la curva
     * @return void
     */
    ...
    /**
     * @brief Metodo para enviar al coche los datos para realizar el circuito
     * @param tipoAccion Indica si mover el servo o el motor
     * @param direccion Indica la direccion en la que se va a mover el servo o el motor
     * @param estado Iniciar o detenerBtn el movimiento
    ...
    /**
     * @brief Metodo para enviar al coche los datos para realizar las diferentes pruebas
     * @param tipoPrueba Indica que tipo de prueba se va a realizar
     * @param direccion Indica la direccion en la que se va a mover el servo o el motor
     * @param estado Iniciar o detenerBtn el movimiento
     * @param valor Valor que varia en funcion del tipo de prueba
     * @return void
     */
    ...
    /**
     * @brief Metodo para comprobar si el dispositivo local esta activo
     * @return boolean
     */
    ...
    /**
     * @brief Metodo para detectar los datos enviados por el coche
    ...
    /**
     * @brief Metodo para obtener el valor del objeto dispositivoLocal
     * @return XBeeDevice
     */
    ...
    /**
     * @brief Metodo para obtener el valor de la variable activado
     * @return boolean
     */
    ...
    /**
     * @brief Metodo para establecer el valor de la variable errorEnvio
     * @return void
     */
