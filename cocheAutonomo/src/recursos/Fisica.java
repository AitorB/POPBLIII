/**
 * @file Fisica.java
 * @brief Clase para realizar calculos fisicos
...
public class Fisica {
    ...
    /**
     * @brief Metodo estatico de clase para la distancia total del recorrido
    ...
    /**
     * @brief Metodo estatico de clase para calcular la velocidad del coche en km/h
     * @param circuito Circuito seleccionado por el usuario
     * @return void
     */
    ...
    /**
     * @brief Metodo estatico de clase para calcular el numero de vueltas de la rueda para completar la recta
     * @param circuito Circuito seleccionado por el usuario
    ...
    /**
     * @brief Metodo estatico de clase para calcular el numero de vueltas de la rueda para completar la curva
     * @param circuito Circuito seleccionado por el usuario
     * @param coche Coche seleccionado por el usuario
     * @return void
     */
    ...
    /**
     * @brief Metodo estatico de clase para calcular el numero de vueltas de la rueda para recorrer el circuito
     * @param coche Coche seleccionado por el usuario
     * @return int
     */
    ...
    /**
     * @brief Metodo estatico de clase para calcular el numero de vueltas de un tramo indicado
    ...
    /**
     * @brief Metodo estatico de clase para calcular el tiempo en dar una vuelta al circuito
     * @param circuito Circuito seleccionado por el usuario
     * @return void
     */
    ...
    /**
     * @brief Metodo estatico de clase para calcular la velocidad media del coche
    ...
    /**
     * @brief Metodo estatico de clase para calcular el movimiento del servo segun el angulo de giro de las ruedas en la curva
     * @param circuito Circuito seleccionado por el usuario
     * @param coche Coche seleccionado por el usuario
     * @return int
     */
