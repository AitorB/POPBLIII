 ...
 *  @brief Clase para crear un diálogo que permite introducir datos del coche
 *  @authors
...
public class DialogoAnadirCoche extends DialogoAnadir {
	...
	protected Component crearPanelDatos() {
		...
		panel.add(new JLabel("Diámetro de la rueda (cm):"));
	...
	/**
	 * @brief Método para comprobar que los campos están vacíos
	 * @return boolean
	 */
	...
	/**
	 * @brief Método para comprobar que los datos introducidos son correctos
	 * @return boolean
	 */
	...
	/**
	 * @brief Método para mostrar datos del coche si ya ha sido previamente introducido
	 * @return void
	 */
	...
	/**
	 * @brief Método para crear un nuevo coche
	 * @return void
	 */
	...
	/**
	 * @brief Método para obtener el valor de la variable nuevoCoche
	 * @return Coche
	 */
